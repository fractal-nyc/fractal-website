...
export const FULL_PROFILES: ResponsiveProfile[] = [
  ...
  { name: "phone-density-375x812", viewport: { width: 375, height: 812 }, hasTouch: true },
  ...
  { name: "phone-density-440x956", viewport: { width: 440, height: 956 }, hasTouch: true },
...
export const FAST_PROFILES = FULL_PROFILES.filter(({ name }) =>
  [
    "phone-320x568",
    "phone-360x640",
    "phone-density-375x812",
    "phone-390x844",
    "phone-density-440x956",
    "landscape-640x360",
    "tablet-1023x1366",
    "boundary-1024x768",
    "desktop-1440x900",
