    ...
    >
      ...
      <div>
        ...
        <section className="relative flex flex-col items-center justify-start pt-16 md:pt-24">
          ...
          <div
            aria-hidden="true"
            className="pointer-events-none absolute inset-x-4 sm:inset-x-8 md:inset-x-12 lg:inset-x-16 top-44 md:top-64 z-0 hidden md:flex items-center justify-between"
