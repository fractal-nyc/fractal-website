      ...
      <div className="min-h-screen flex items-center justify-center w-full">
        <section className="w-full">
          <div className="px-6 md:px-[4.5%] text-center">
            ...
            <FadeIn>
              <p className="font-serif text-4xl md:text-6xl leading-[1.3] mb-10 text-center" style={{ fontWeight: 300, textTransform: "uppercase", fontStyle: "normal" }}>
            ...
            <FadeIn delay={0.15}>
              <div className="border border-foreground/20 rounded-md px-5 py-5 mb-10 bg-foreground/[0.03] text-left">
                ...
                <ol className="list-decimal list-inside mt-3 space-y-2 text-base leading-relaxed text-white">
