    ...
    <main className="relative min-h-screen bg-house-education-deep text-background selection:bg-background selection:text-foreground" style={{ "--accent": "var(--color-house-education-light)" } as CSSProperties}>
      ...
      <div className="relative z-10"><Navbar />
        <section className="page-gutter mx-auto w-full max-w-7xl pb-16 pt-28 md:pt-36">
          ...
          <FadeIn><div className="mx-auto max-w-4xl text-center"><h1 className="text-display">An improvised college in New York City.</h1><p className="mx-auto mt-6 max-w-2xl text-body-lead">We're a community of people who want to learn, conduct research, and do great work together.</p></div></FadeIn>
          <FadeIn delay={0.1}><picture className="mt-10 block overflow-hidden rounded-lg"><source media="(max-width: 767px)" srcSet="/images/fractalu-mobile.png" /><img src="/images/fractalu.png" alt="" className="h-64 w-full object-cover md:h-96" /></picture></FadeIn>
        </section>
