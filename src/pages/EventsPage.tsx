          ...
          <FadeIn delay={0.1}>
            ...
            */}
            ...
            <a
              ...
              className="block max-w-3xl mx-auto mb-12 text-body font-mono text-foreground/90 leading-relaxed text-center underline decoration-foreground/40 hover:decoration-foreground transition-colors"
            >
