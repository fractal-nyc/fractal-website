...
// FractalU is internal at /fractalu. The Accelerator remains external and its
// search result carries `external: true` so Hero opens it in a new tab.
...
const PAGES: PageEntry[] = [
  ...
  { name: "FractalU", href: "/fractalu", keywords: ["new liberal arts", "liberal arts", "fractal u", "fractal university", "university", "school", "education", "courses", "classes"] },
...
const CONCEPT_ALIASES: { term: string; results: SearchResult[] }[] = [
  {
    term: "fractal u",
    results: [{ type: "page", title: "FractalU", subtitle: "Fractal University", href: "/fractalu" }],
  },
  {
